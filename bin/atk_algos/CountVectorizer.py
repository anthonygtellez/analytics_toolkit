...
class CountVectorizer(BaseAlgo):
    ...
    def __init__(self, options):
        ...
        self.estimator = _CountVectorizer(**out_params)
    ...
    def make_output_names(self, options):
        default_name = self.feature_variables[0] + '_CountVectorizer'
    ...
    def register_codecs():
        ...
        codecs_manager.add_codec('algos.CountVectorizer', 'CountVectorizer', SimpleObjectCodec)
